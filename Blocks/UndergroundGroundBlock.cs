...
{
    public class UndergroundGroundBlock : AbstractBlock
    {
        public UndergroundGroundBlock(Vector2 location)
        {
            Location = location;
            Sprite = UniversalSpriteFactory.Instance.CreateSprite("UndergroundGroundBlock", location);
        }
