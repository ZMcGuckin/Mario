...
{
    public class DeadMarioSprite : AbstractMarioSprite
    {
        //Little Mario Spritesheet locations
        readonly int DeadMarioFrame = 6;

        public DeadMarioSprite(Texture2D littleMarioSheet)
        {
            Texture = littleMarioSheet;
            CurrentFrame = DeadMarioFrame;
        }
