...
{
    public class BigMarioJumpingSprite : AbstractMarioSprite
    {
        //Big Mario Spritesheet locations
        readonly int BigMarioJumping = 4;

        public BigMarioJumpingSprite(Texture2D bigMarioSheet)
        {
            Texture = bigMarioSheet;
            CurrentFrame = BigMarioJumping;
        }
