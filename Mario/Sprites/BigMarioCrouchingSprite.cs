...
{
    public class BigMarioCrouchingSprite : AbstractMarioSprite
    {
        //Big Mario Spritesheet locations
        readonly int BigMarioCrouching = 5;

        public BigMarioCrouchingSprite(Texture2D bigMarioSheet)
        {
            Texture = bigMarioSheet;
            CurrentFrame = BigMarioCrouching;
        }
        ...
        {
            return new Rectangle((int)location.X, (int)location.Y + Texture.Height/Rows/2, Texture.Width / Cols * GameConstants.PlayerScaleFactor, (int)(Texture.Height / Rows) * GameConstants.PlayerScaleFactor - Texture.Height / Rows / 2);
        }
    }
}
