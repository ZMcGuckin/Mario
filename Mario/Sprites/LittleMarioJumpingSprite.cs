...
{
    public class LittleMarioJumpingSprite : AbstractMarioSprite
    {
        //Little Mario Spritesheet locations
        readonly int LittleMarioJumping = 2;

        public LittleMarioJumpingSprite(Texture2D littleMarioSheet)
        {
            Texture = littleMarioSheet;
            CurrentFrame = LittleMarioJumping;
        }
