...
{
    public class LittleMarioIdleSprite : AbstractMarioSprite
    {
        //Little Mario Spritesheet locations
        readonly int LittleMarioIdle = 1;

        public LittleMarioIdleSprite(Texture2D littleMarioSheet)
        {
            Texture = littleMarioSheet;
            CurrentFrame = LittleMarioIdle;
        }
